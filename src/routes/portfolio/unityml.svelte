...
<div class="background bg-base-200 p-10 min-h-screen">
	...
	>
		...
		<p>
			We decided to use a new piece of software for the term project. We were already using Unity as
		...
		<p>
			We wanted to give the students hands on experience with training an intelligent agent, and we
		...
		<ul>
			<li>
				Pay more attention to dependencies. Some students (especially M1 mac users) had difficulties
